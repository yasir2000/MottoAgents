...
from mottoagents.system.const import DATA_PATH
from mottoagents.system.document_store.base_store import LocalStore
from mottoagents.system.document_store.document import Document
