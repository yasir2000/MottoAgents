...
ROLES_LIST = [
    ...
    },
    {
        ...
        'description': 'A specialized BDI agent that provides motivation, encouragement, and emotional support to help users maintain high energy, focus, and positive mood while working on tasks.',
        'requirements': 'Can be selected for any task where user motivation and emotional support is desired.',
    }
]
...
ROLES_MAPPING = {
    ...
    'Engineer': Engineer,
    'MotivationCoach': MotivationAgent,
}