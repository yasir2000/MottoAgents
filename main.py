...
import re
import logging
from mottoagents.roles import Manager, ObserverAgents, ObserverPlans
from mottoagents.explorer import Explorer
import startup
import ws_service
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="mottoagents")
